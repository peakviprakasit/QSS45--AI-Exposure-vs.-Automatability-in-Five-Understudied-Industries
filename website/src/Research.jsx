  ...
  return (
    <>
      ...
      <header id="top" className="hero">
        ...
        <div className="container hero-grid">
          <div className="hero-lead">
            ...
            <h1>
              Jobs are increasingly <span className="ac1">integrating</span> AI, not being{' '}
            ...
            <p className="lede">
              ...
              into a single &ldquo;AI&nbsp;risk, measured separately.
            </p>
            <div className="cta">
          ...
          <aside className="dossier reveal" aria-label="Study dossier">
            <div className="dossier-head">
              <span className="meta">Study Brief</span>
            ...
            <div className="dossier-sect findings">
              ...
              <dl>
                <div className="lrow"><dt>AI exposure</dt><dd className="up">Over 60% Increase<small>p = 2.6×10⁻⁸</small></dd></div>
                <div className="lrow"><dt>Automatability</dt><dd className="flat">Relatively Flat<small>p = 0.31</small></dd></div>
      ...
      <Section
        ...
        sub="Two dimensions that public debate keeps condensing into one, measured on perpendicular axes."
      >
        ...
        <div className="axes-cue reveal">
          ...
          <div className="ac-plot">
            ...
            <span className="ac-note">
              Two independent dimensions rather than one, combined risk score. <b>Across 2,614 postings, r = −0.11.</b>
            </span>
          </div>
        </div>
      </Section>
      ...
      >
        <p className="prose reveal">
          I attained/scraped LinkedIn postings for the five industries which include farming &amp; forestry, insurance, legal services, patent/IP, and
          pharmaceutical &amp; chemical manufacturing at two points: April&nbsp;2024 (Kaggle Dataset) and May&nbsp;2026 (Scrape). The
          five sectors are a deliberate choice: work on AI and jobs tends to revolve around software, analyst and related
          professions, so these <strong>manual, clerical, and knowledge</strong> sectors rarely make the
          sample, yet together they span the work where AI&rsquo;s reach is still strongly contested.
        </p>
        ...
        <div className="ledger reveal">
          ...
          <div className="ledger-body">
            ...
            <div className="lrow"><span className="k">Industries</span><span className="v">5 understudied industries</span></div>
        ...
        <div className="notebox reveal">
          ...
          <p>
            ...
            two-snapshot comparison, <strong>not a time series</strong>, therefore, every result is reported within
        ...
        <p className="prose reveal">
          ...
          single sector or year drives the comparison. A naive keyword count won&rsquo;t suffice: AI-term prevalence tracks posting length and house style as much as real content (as shown on the Heatmap), which is
      ...
      >
        <p className="prose reveal">
          ...
          gpt-5.4 for exposure, gpt-5.4-mini for automatability. The measure is then validated rather
          than trusted.
        </p>
        ...
        <p className="prose reveal">
          Validation matters more than the model itself. Exposure clears four bars: it <strong>agrees</strong>{' '}
          ...
          truth because there is no registry of which tasks <em>could</em> be automated. Therefore, it rests on face and
      ...
      >
        ...
        <p className="pullquote reveal">
          ...
          the share a machine could actually perform <span className="hl">barely moved</span>.
        </p>
        ...
        <p className="prose reveal">
          The movement is not uniform. It predominantly stacks up in knowledge work: Patent/IP, legal services, and pharma all
          advertise sharply more AI-involved roles by 2026. On the other hand, farming and insurance, if anything, slip back.
          The second axis stays put across every sector, and the two are nearly orthogonal: a role&rsquo;s
          exposure tells almost nothing about its automatability.
        </p>
        ...
        <div className="fig-aside">
          <Embed
            ...
            height={560}
            caption="AI exposure by industry, 2024 vs. 2026. Hover a line for its ×multiplier, the core of the divergence."
            source="Model-labeled · gpt-5.4"
          />
          <div className="sidebar reveal">
            <p className="sb-lab">Why knowledge work?</p>
            <p>
              2024–2026 saw a significant growth and rapid development of generative-AI, and today&rsquo;s models are strongest at the language and
              document-heavy tasks (drafting, search, synthesis, review) which is the bulk of patent, legal, and
              pharmaceutical work. Where AI <strong>complements</strong> existing expertise, employers advertise
              it, and where a sector&rsquo;s core is physical (farming) or transactional (insurance), today&rsquo;s
            ...
            <p>
              One honest caution: exposure is read from a posting&rsquo;s <em>language</em>, so part of that rise
        ...
        <Embed
          ...
          caption="The full 2024 to 2026 distribution shift: exposure pulls right while automatability's curves overlap. Use the menu to toggle measures."
      ...
      <section id="takeaway" className="takeaway">
        ...
        <div className="container">
          ...
          <p className="big reveal">
            ...
            becoming more <span className="ac2">replaceable</span>. The two constructs are almost independent.
            Collapsing them into one &ldquo;AI&nbsp;risk&rdquo; score hides the real pattern.
          </p>
          <p className="research-note reveal">
            <b>Read it carefully.</b> A two-snapshot design (no causal claims), an AI-drafted (audited) audit set, and LinkedIn&rsquo;s skew toward formal white-collar postings all bound
      ...
      <footer className="footer">
        <div className="container">
          <p className="note">
            ...
            <em> replaceable</em> by it, two questions examining separately.
          </p>
          <div className="foot-grid">
            ...
            <div className="foot-col">
              ...
              <p>
                ...
                100-posting audit set. A two-snapshot design: year is confounded with scrape source and all
